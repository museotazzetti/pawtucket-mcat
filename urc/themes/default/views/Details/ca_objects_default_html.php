...
?>
			...
			<div class='col-sm-6 col-md-6 col-lg-5'>
				...
				{{{<ifdef code="ca_objects.idno"><H6>Numero di accessione</H6>^ca_objects.idno<br/></ifdef>}}}
				{{{<ifdef code="ca_objects.containerID"><H6>Box/series:</H6>^ca_objects.containerID<br/></ifdef>}}}				
				
				{{{<ifdef code="ca_objects.description">
					<div class='unit'><h6>Descrizione</h6>
				...
				{{{<ifdef code="ca_objects.date"><H6>Data</H6>^ca_objects.date<br/></ifdef>}}}
				{{{<ifdef code="ca_objects.inscription"><H6>Inscrizioni</H6>^ca_objects.inscription<br/></ifdef>}}}

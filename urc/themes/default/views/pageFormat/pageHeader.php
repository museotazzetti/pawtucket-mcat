...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'museo-tazzetti-vect-transp-back.png'), "navbar-brand logo", "", "","");
?>
			</div>
...
?>
				<form class="navbar-form navbar-right" role="search" action="<?php print caNavUrl($this->request, '', 'MultiSearch', 'Index'); ?>">
					<div class="formOutline">
						<div class="form-group">
							<input type="text" class="form-control" id="headerSearchInput" placeholder="Cerca" name="search" autocomplete="off" />
						</div>
				...
				<ul class="nav navbar-nav navbar-right menuItems">
					<li <?php print ($this->request->getController() == "About") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Il progetto"), "", "", "About", "Index"); ?></li>
